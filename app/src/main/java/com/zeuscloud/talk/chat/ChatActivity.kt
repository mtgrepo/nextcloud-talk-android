...
package com.zeuscloud.talk.chat
...
import com.zeuscloud.talk.activities.BaseActivity
import com.zeuscloud.talk.activities.CallActivity
import com.zeuscloud.talk.activities.TakePhotoActivity
import com.zeuscloud.talk.adapters.messages.CommonMessageInterface
import com.zeuscloud.talk.adapters.messages.IncomingLinkPreviewMessageViewHolder
import com.zeuscloud.talk.adapters.messages.IncomingLocationMessageViewHolder
import com.zeuscloud.talk.adapters.messages.IncomingPollMessageViewHolder
import com.zeuscloud.talk.adapters.messages.IncomingPreviewMessageViewHolder
import com.zeuscloud.talk.adapters.messages.IncomingTextMessageViewHolder
import com.zeuscloud.talk.adapters.messages.IncomingVoiceMessageViewHolder
import com.zeuscloud.talk.adapters.messages.MessagePayload
import com.zeuscloud.talk.adapters.messages.OutcomingLinkPreviewMessageViewHolder
import com.zeuscloud.talk.adapters.messages.OutcomingLocationMessageViewHolder
import com.zeuscloud.talk.adapters.messages.OutcomingPollMessageViewHolder
import com.zeuscloud.talk.adapters.messages.OutcomingPreviewMessageViewHolder
import com.zeuscloud.talk.adapters.messages.OutcomingTextMessageViewHolder
import com.zeuscloud.talk.adapters.messages.OutcomingVoiceMessageViewHolder
import com.zeuscloud.talk.adapters.messages.PreviewMessageInterface
import com.zeuscloud.talk.adapters.messages.PreviewMessageViewHolder
import com.zeuscloud.talk.adapters.messages.SystemMessageInterface
import com.zeuscloud.talk.adapters.messages.SystemMessageViewHolder
import com.zeuscloud.talk.adapters.messages.TalkMessagesListAdapter
import com.zeuscloud.talk.adapters.messages.UnreadNoticeMessageViewHolder
import com.zeuscloud.talk.adapters.messages.VoiceMessageInterface
import com.zeuscloud.talk.api.NcApi
import com.zeuscloud.talk.application.NextcloudTalkApplication
import com.zeuscloud.talk.callbacks.MentionAutocompleteCallback
import com.zeuscloud.talk.chat.viewmodels.ChatViewModel
import com.zeuscloud.talk.conversationinfo.ConversationInfoActivity
import com.zeuscloud.talk.conversationlist.ConversationsListActivity
import com.zeuscloud.talk.data.user.model.User
import com.zeuscloud.talk.databinding.ActivityChatBinding
import com.zeuscloud.talk.events.UserMentionClickEvent
import com.zeuscloud.talk.events.WebSocketCommunicationEvent
import com.zeuscloud.talk.extensions.loadAvatarOrImagePreview
import com.zeuscloud.talk.jobs.DownloadFileToCacheWorker
import com.zeuscloud.talk.jobs.ShareOperationWorker
import com.zeuscloud.talk.jobs.UploadAndShareFilesWorker
import com.zeuscloud.talk.location.LocationPickerActivity
import com.zeuscloud.talk.messagesearch.MessageSearchActivity
import com.zeuscloud.talk.models.domain.ConversationModel
import com.zeuscloud.talk.models.domain.ConversationReadOnlyState
import com.zeuscloud.talk.models.domain.ConversationType
import com.zeuscloud.talk.models.domain.LobbyState
import com.zeuscloud.talk.models.domain.ObjectType
import com.zeuscloud.talk.models.domain.ReactionAddedModel
import com.zeuscloud.talk.models.domain.ReactionDeletedModel
import com.zeuscloud.talk.models.json.chat.ChatMessage
import com.zeuscloud.talk.models.json.chat.ChatOverall
import com.zeuscloud.talk.models.json.chat.ChatOverallSingleMessage
import com.zeuscloud.talk.models.json.chat.ReadStatus
import com.zeuscloud.talk.models.json.conversations.RoomOverall
...
import com.zeuscloud.talk.polls.ui.PollCreateDialogFragment
import com.zeuscloud.talk.presenters.MentionAutocompletePresenter
import com.zeuscloud.talk.remotefilebrowser.activities.RemoteFileBrowserActivity
...
import com.zeuscloud.talk.signaling.SignalingMessageSender
import com.zeuscloud.talk.translate.ui.TranslateActivity
import com.zeuscloud.talk.ui.MicInputCloud
import com.zeuscloud.talk.ui.StatusDrawable
import com.zeuscloud.talk.ui.bottom.sheet.ProfileBottomSheet
import com.zeuscloud.talk.ui.dialog.AttachmentDialog
import com.zeuscloud.talk.ui.dialog.DateTimePickerFragment
import com.zeuscloud.talk.ui.dialog.MessageActionsDialog
import com.zeuscloud.talk.ui.dialog.ShowReactionsDialog
import com.zeuscloud.talk.ui.recyclerview.MessageSwipeActions
import com.zeuscloud.talk.ui.recyclerview.MessageSwipeCallback
import com.zeuscloud.talk.utils.ApiUtils
import com.zeuscloud.talk.utils.AudioUtils.audioFileToFloatArray
import com.zeuscloud.talk.utils.ContactUtils
import com.zeuscloud.talk.utils.ConversationUtils
...
import com.zeuscloud.talk.utils.FileUtils
import com.zeuscloud.talk.utils.FileViewerUtils
import com.zeuscloud.talk.utils.ImageEmojiEditText
import com.zeuscloud.talk.utils.MagicCharPolicy
import com.zeuscloud.talk.utils.Mimetype
import com.zeuscloud.talk.utils.NotificationUtils
import com.zeuscloud.talk.utils.ParticipantPermissions
import com.zeuscloud.talk.utils.UriUtils
import com.zeuscloud.talk.utils.VibrationUtils
import com.zeuscloud.talk.utils.bundle.BundleKeys
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_CALL_VOICE_ONLY
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_CONVERSATION_NAME
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_FILE_PATHS
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_INTERNAL_USER_ID
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_IS_BREAKOUT_ROOM
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_IS_MODERATOR
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_RECORDING_STATE
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_ROOM_ID
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_ROOM_TOKEN
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_START_CALL_AFTER_ROOM_SWITCH
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_SWITCH_TO_ROOM
import com.zeuscloud.talk.utils.database.user.CapabilitiesUtilNew
import com.zeuscloud.talk.utils.database.user.CurrentUserProviderNew
import com.zeuscloud.talk.utils.permissions.PlatformPermissionUtil
import com.zeuscloud.talk.utils.rx.DisposableSet
import com.zeuscloud.talk.utils.singletons.ApplicationWideCurrentRoomHolder
import com.zeuscloud.talk.utils.text.Spans
import com.zeuscloud.talk.webrtc.WebSocketConnectionHelper
import com.zeuscloud.talk.webrtc.WebSocketInstance
