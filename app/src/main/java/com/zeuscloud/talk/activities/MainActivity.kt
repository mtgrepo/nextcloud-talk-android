...
import com.zeuscloud.talk.databinding.ActivityMainBinding
import com.zeuscloud.talk.lock.LockedActivity
...
import com.zeuscloud.talk.utils.bundle.BundleKeys.ADD_ACCOUNT
...
class MainActivity : BaseActivity(), ActionBarProvider {
    ...
    private fun handleActionFromContact(intent: Intent) {
        if (intent.action == Intent.ACTION_VIEW && intent.data != null) {
            ...
            when (intent.type) {
                "vnd.android.cursor.item/vnd.com.zeuscloud.talk2.chat" -> {
