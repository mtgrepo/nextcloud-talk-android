...
import com.zeuscloud.talk.adapters.ParticipantDisplayItem
import com.zeuscloud.talk.adapters.ParticipantsAdapter
...
import com.zeuscloud.talk.call.CallParticipant
import com.zeuscloud.talk.call.CallParticipantList
import com.zeuscloud.talk.call.CallParticipantModel
import com.zeuscloud.talk.call.ReactionAnimator
import com.zeuscloud.talk.chat.ChatActivity
import com.zeuscloud.talk.data.user.model.User
import com.zeuscloud.talk.databinding.CallActivityBinding
import com.zeuscloud.talk.events.ConfigurationChangeEvent
import com.zeuscloud.talk.events.NetworkEvent
import com.zeuscloud.talk.events.ProximitySensorEvent
import com.zeuscloud.talk.events.WebSocketCommunicationEvent
import com.zeuscloud.talk.models.ExternalSignalingServer
import com.zeuscloud.talk.models.json.capabilities.CapabilitiesOverall
...
import com.zeuscloud.talk.models.json.signaling.DataChannelMessage
import com.zeuscloud.talk.models.json.signaling.NCSignalingMessage
import com.zeuscloud.talk.models.json.signaling.Signaling
import com.zeuscloud.talk.models.json.signaling.SignalingOverall
import com.zeuscloud.talk.models.json.signaling.settings.SignalingSettingsOverall
import com.zeuscloud.talk.raisehand.viewmodel.RaiseHandViewModel
import com.zeuscloud.talk.raisehand.viewmodel.RaiseHandViewModel.LoweredHandState
import com.zeuscloud.talk.raisehand.viewmodel.RaiseHandViewModel.RaisedHandState
import com.zeuscloud.talk.signaling.SignalingMessageReceiver
import com.zeuscloud.talk.signaling.SignalingMessageReceiver.CallParticipantMessageListener
import com.zeuscloud.talk.signaling.SignalingMessageReceiver.LocalParticipantMessageListener
import com.zeuscloud.talk.signaling.SignalingMessageReceiver.OfferMessageListener
import com.zeuscloud.talk.signaling.SignalingMessageSender
import com.zeuscloud.talk.ui.dialog.AudioOutputDialog
import com.zeuscloud.talk.ui.dialog.MoreCallActionsDialog
...
import com.zeuscloud.talk.utils.NotificationUtils.cancelExistingNotificationsForRoom
import com.zeuscloud.talk.utils.NotificationUtils.getCallRingtoneUri
import com.zeuscloud.talk.utils.VibrationUtils.vibrateShort
import com.zeuscloud.talk.utils.animations.PulseAnimation
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_CALL_VOICE_ONLY
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_CALL_WITHOUT_NOTIFICATION
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_CONVERSATION_NAME
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_CONVERSATION_PASSWORD
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_FROM_NOTIFICATION_START_CALL
...
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_MODIFIED_BASE_URL
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_PARTICIPANT_PERMISSION_CAN_PUBLISH_AUDIO
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_PARTICIPANT_PERMISSION_CAN_PUBLISH_VIDEO
...
import com.zeuscloud.talk.utils.database.user.CapabilitiesUtilNew.hasSpreedFeatureCapability
import com.zeuscloud.talk.utils.database.user.CapabilitiesUtilNew.isCallRecordingAvailable
...
import com.zeuscloud.talk.utils.power.PowerManagerUtils
import com.zeuscloud.talk.utils.singletons.ApplicationWideCurrentRoomHolder
import com.zeuscloud.talk.viewmodels.CallRecordingViewModel
import com.zeuscloud.talk.viewmodels.CallRecordingViewModel.RecordingConfirmStopState
import com.zeuscloud.talk.viewmodels.CallRecordingViewModel.RecordingErrorState
import com.zeuscloud.talk.viewmodels.CallRecordingViewModel.RecordingStartedState
import com.zeuscloud.talk.viewmodels.CallRecordingViewModel.RecordingStartingState
import com.zeuscloud.talk.webrtc.MagicWebRTCUtils
import com.zeuscloud.talk.webrtc.PeerConnectionWrapper
...
import com.zeuscloud.talk.webrtc.WebRtcAudioManager.AudioDevice
