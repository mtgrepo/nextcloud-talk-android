...
import com.zeuscloud.talk.callnotification.CallNotificationActivity
import com.zeuscloud.talk.models.SignatureVerification
import com.zeuscloud.talk.models.json.chat.ChatUtils.Companion.getParsedMessage
import com.zeuscloud.talk.models.json.conversations.RoomOverall
import com.zeuscloud.talk.models.json.notifications.NotificationOverall
import com.zeuscloud.talk.models.json.participants.Participant
import com.zeuscloud.talk.models.json.participants.ParticipantsOverall
import com.zeuscloud.talk.models.json.push.DecryptedPushMessage
import com.zeuscloud.talk.models.json.push.NotificationUser
import com.zeuscloud.talk.receivers.DirectReplyReceiver
import com.zeuscloud.talk.receivers.DismissRecordingAvailableReceiver
import com.zeuscloud.talk.receivers.MarkAsReadReceiver
import com.zeuscloud.talk.receivers.ShareRecordingToChatReceiver
import com.zeuscloud.talk.utils.ApiUtils
import com.zeuscloud.talk.utils.DoNotDisturbUtils.shouldPlaySound
import com.zeuscloud.talk.utils.NotificationUtils
import com.zeuscloud.talk.utils.NotificationUtils.cancelAllNotificationsForAccount
import com.zeuscloud.talk.utils.NotificationUtils.cancelNotification
import com.zeuscloud.talk.utils.NotificationUtils.findNotificationForRoom
import com.zeuscloud.talk.utils.NotificationUtils.getCallRingtoneUri
import com.zeuscloud.talk.utils.NotificationUtils.getMessageRingtoneUri
import com.zeuscloud.talk.utils.NotificationUtils.loadAvatarSync
import com.zeuscloud.talk.utils.PushUtils
import com.zeuscloud.talk.utils.bundle.BundleKeys
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_DISMISS_RECORDING_URL
...
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_MESSAGE_ID
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_NOTIFICATION_ID
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_NOTIFICATION_RESTRICT_DELETION
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_NOTIFICATION_TIMESTAMP
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_ROOM_TOKEN
import com.zeuscloud.talk.utils.bundle.BundleKeys.KEY_SHARE_RECORDING_TO_CHAT_URL
...
class NotificationWorker(context: Context, workerParams: WorkerParameters) : Worker(context, workerParams) {
    ...
    private fun enrichPushMessageByNcNotificationData(
        ncNotification: com.zeuscloud.talk.models.json.notifications.Notification
    ) {
    ...
    private fun showNotification(
        ...
        val notificationBuilder = NotificationCompat.Builder(context!!, "1")
            ...
            .setSmallIcon(R.drawable.talk_logo)
